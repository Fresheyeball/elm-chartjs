...
{-| API wrapper for Chartjs Pie charts
...
[Chartjs Docs](http://www.chartjs.org/docs/#pie-chart-chart-options).
...
[Chartjs Docs](http://www.chartjs.org/docs/#pie-chart-data-structure)
-}
type alias Style =
  { color: Color
  , highlight: Color }
...
{-| Create a Chartjs Pie Chart in an Element

    chart height width myConfig defaultOptions

-}
chart : Int -> Int -> Config -> Options -> Element
chart w h c o = chartRaw "Pie" w h (decodeConfig c) (decodeOptions o)
