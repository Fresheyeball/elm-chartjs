...
}).call(this);// Generated by LiveScript 1.4.0
(function(){
  var sanitizeNS;
  sanitizeNS = function(x){
    var ref$;
    x.Native || (x.Native = {});
    return (ref$ = x.Native).Chartjs || (ref$.Chartjs = {});
  };
  sanitizeNS(Elm);
  (function(make){
    ...
    var v, NativeElement, toArray, createNode, setWrapSize, update, render, showRGBA, chartRaw;
    ...
    setWrapSize = function(wrap, arg$){
      var w, h, setWH, ratio, canvas;
      w = arg$.w, h = arg$.h;
      setWH = function(w_, h_, x){
        x.width = w_ + "px";
        x.height = h_ + "px";
      };
    ...
    update = curry$(function(type, wrap, _, model){
    ...
    render = curry$(function(type, model){
      var wrap, canvas;
      wrap = createNode("div");
      ...
      setWrapSize(wrap, model);
      setTimeout(function(){
        return update(type, wrap, model, model);
      }, 0);
      return wrap;
    });
